...
export function initShowcaseSection(sceneContext) {
  ...
  panels.forEach((panel, i) => {
    ...
    const content = panel.querySelector(".alien-content");
    ...
    tl.fromTo(title, { opacity: 0, y: 40 }, { opacity: 1, y: 0, duration: 0.6, ease: "power2.out" }, 0.1);
    tl.fromTo(subtitle, { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.5, ease: "power2.out" }, 0.2);
    tl.fromTo(body, { opacity: 0, y: 30 }, { opacity: 1, y: 0, duration: 0.5, ease: "power2.out" }, 0.3);
    tl.fromTo(stats, { scaleX: 0 }, { scaleX: 1, stagger: 0.1, duration: 0.6, ease: "power2.out" }, 0.5);
